...
if MODE == 'cptc':
    ...
    for team in team_list:
        ...
        alert_table_name = team + "_alert_final"  # table name for inter-host connections 
        host_log_table_name = team + "_bash" # table name for intra-host operations
...
### use MSAS dataset
    ...
    for i, scene in enumerate(scene_list):
        ...
        alert_table_name = scene + "_connection_new" # table name for inter-host connections
